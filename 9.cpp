...
int main()
{
    ...
    cust.InsertNode("Radhika", "April", "Badminton", 19, "122", 1, 800, 1100);
    cust.InsertNode("Lakshya", "May", "Netball", 24, "960", 15, 1500, 1800);
    cust.InsertNode("Shreya", "September", "Bowling", 18, "201", 29, 1100, 1400);
    cust.InsertNode("Molshree", "November", "Swimming", 32, "880", 18, 1400, 1700);
    cust.InsertNode("Siddhartha", "December", "Badminton", 25, "950", 21, 2000, 2300);
    cust.InsertNode("Harsh", "February", "Futsal", 42, "780", 9, 2000, 2300);
    cust.InsertNode("Mihika", "January", "Bowling", 37, "831", 8, 1600, 1900);
    cust.InsertNode("Naman", "July", "Ping Pong", 31, "890", 14, 900, 1100);
